...
par(mfrow = c(1,2))
hist(diffAge, breaks = "FD", main = "Randomly Mixed Populations", xlab = "difference in averages of ages", col = "lightgrey")
abline(v = diffAveAge(pop), col = "red", lwd = 2)
hist(diffAge, breaks = "FD", main = "Randomly Mixed Populations", xlab = "ratio of standard deviations",col = "lightgrey")
